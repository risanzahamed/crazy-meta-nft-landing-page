        ...
        <div>
            ...
            <section className=" dark:bg-gray-900">
                <div className="max-w-[1350px] px-6 py-10 mx-auto">
                    <h2 className='text-[16px] mb-2 text-[#00FFA3] font-bold'>OUR GOALS</h2>
                    <h2 className='lg:text-[48px] text-[32px] mb-6 text-white font-bold'>ROADMAP</h2>

                    <img src="https://bithu.uigaint.com/wp-content/uploads/2022/06/v1_roadmap_divider_shape.png" className='mb-10 w-[1350px]' alt="" />

                    <div className="grid grid-cols-1 gap-8  xl:gap-16 md:grid-cols-2 xl:grid-cols-3">
                        <div className="flex flex-col items-left   text-left   dark:bg-gray-800">


                            <div>

                                <h1 className="text-xl mt-2 font-bold text-[#00FFA3] capitalize dark:text-white">
                                    PHASE 01
                                </h1>
                                <h1 className="text-3xl mb-2 mt-2 font-bold text-white capitalize dark:text-white">
                                    20% Soldout
                                </h1>
                        ...
                        <div className="flex flex-col items-left   text-left   dark:bg-gray-800">
                            ...
                            <p className="text-slate-300 dark:text-gray-300">
                                Pleasure and praising pain was born and I will give you a complete account of the system, and expound the actual teachings of the great explorer of the truth, the master-builder of human.
                            </p>
